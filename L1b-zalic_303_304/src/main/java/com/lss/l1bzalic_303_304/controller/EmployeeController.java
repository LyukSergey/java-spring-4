...
public class EmployeeController {
    ...
    public ResponseEntity<List<EmployeeDto>> findByLastNameStartsWith(@RequestParam("prefix") String prefix) {
        return ResponseEntity.ok(employeeService.findByLastNameStartsWith(prefix));
    }
}
